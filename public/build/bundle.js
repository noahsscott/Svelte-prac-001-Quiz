...
var app = (function () {
    ...
    // (46:0) {#each allAnswers as answer}
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "answer svelte-hmcg4u");
    			button.disabled = /*isAnswered*/ ctx[3];
    			add_location(button, file$3, 47, 2, 911);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(46:0) {#each allAnswers as answer}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br, file$3, 55, 2, 1077);
    			add_location(button, file$3, 56, 2, 1086);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$3, 43, 0, 805);
    		},
    ...
    class Question extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { question: 0, nextQuestion: 1 });
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "fade-wrapper svelte-6nvs3");
    			add_location(div, file$1, 72, 10, 1738);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(72:8) {#if index == activeQuestion}",
    		ctx
    	});
    ...
    // (71:6) {#each data.results as question, index}
    function create_each_block(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*index*/ ctx[10] == /*activeQuestion*/ ctx[0] && create_if_block_1(ctx);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(71:6) {#each data.results as question, index}",
    		ctx
    	});
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(68:17)        Loading...     {:then data}",
    		ctx
    	});
    ...
    // (85:2) <Modal on:closeModal={resetQuiz}>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 85, 4, 2186);
    			add_location(p, file$1, 86, 4, 2223);
    			add_location(button, file$1, 87, 4, 2253);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(85:2) <Modal on:closeModal={resetQuiz}>",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (if_block) if_block.c();
    			if_block_anchor = empty();
    			add_location(button, file$1, 61, 2, 1443);
    			add_location(h3, file$1, 63, 2, 1499);
    			add_location(h4, file$1, 64, 2, 1529);
    			attr_dev(div0, "class", "container svelte-6nvs3");
    			add_location(div0, file$1, 66, 2, 1568);
    			add_location(div1, file$1, 60, 0, 1435);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    async function getQuiz() {
    	const res = await fetch("https://opentdb.com/api.php?amount=12&category=11&type=multiple");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1spjpx4");
    			add_location(h1, file, 4, 0, 84);
    			attr_dev(main, "class", "svelte-1spjpx4");
