    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h2 = element("h2");
    			h2.textContent = `${/*quizName*/ ctx[0]}`;
    			add_location(h2, file$1, 6, 2, 73);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-jkcwrm");
    			add_location(h1, file, 5, 1, 91);
    			attr_dev(main, "class", "svelte-jkcwrm");
    			add_location(main, file, 4, 0, 83);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
