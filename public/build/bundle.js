...
var app = (function () {
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 10, 2, 176);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(10:0) {#each answers as answer}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(h3, file$2, 7, 0, 112);
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (question === undefined && !('question' in $$props || $$self.$$.bound[$$self.$$.props['question']])) {
    			console_1$1.warn("<Question> was created without expected prop 'question'");
    		}
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<Question> was created with unknown prop '${key}'`);
    	});
    ...
    // (1:0) <script>   import Question from "./Question.svelte";    async function getQuiz() {     const res = await fetch(       "https://opentdb.com/api.php?amount=10&category=12&type=multiple"     );     const quiz = await res.json();     console.log("new quiz requested");     return quiz;   }
    function create_catch_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "catch",
    		source: "(1:0) <script>   import Question from \\\"./Question.svelte\\\";    async function getQuiz() {     const res = await fetch(       \\\"https://opentdb.com/api.php?amount=10&category=12&type=multiple\\\"     );     const quiz = await res.json();     console.log(\\\"new quiz requested\\\");     return quiz;   }",
    		ctx
    	});
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(23:15)      Loading...   {:then data}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			info.block.c();
    			add_location(button, file$1, 20, 2, 384);
    			add_location(div, file$1, 19, 0, 376);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*handleClick*/ ctx[1], false, false, false, false);
    				mounted = true;
    			}
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Question, getQuiz, quiz, handleClick });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			h4 = element("h4");
    			h4.textContent = "I'm an h4 too";
    			t3 = space();
    			create_component(quiz.$$.fragment);
    			attr_dev(h1, "class", "svelte-iapwc0");
    			add_location(h1, file, 5, 2, 93);
    			add_location(h4, file, 6, 2, 116);
    			attr_dev(main, "class", "svelte-iapwc0");
